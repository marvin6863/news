...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.posts.list', compact('data', 'page_name'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.posts.create', compact('page_name', 'categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Image::make($file)
            ->resize(653, 569)
            ->save(public_path('/post/' . $main_image));
        Image::make($file)
            ->resize(360, 309)
            ->save(public_path('/post/' . $list_image));
        Image::make($file)
            ->resize(122, 122)
            ->save(public_path('/post/' . $thumb_image));
    ...
    public function edit($id)
    {
        ...
        $post = Post::find($id);
        $categories = Category::where('status', 1)->pluck('name', 'id');
        return view('admin.posts.edit', compact('page_name', 'post', 'categories'));
    }
    ...
    public function hot_news($id)
    {
        ...
        return redirect()
            ->action('Admin\PostController@index')
            ->with('success', 'Post Set As Hot News Changed Successfully');
    }
}
