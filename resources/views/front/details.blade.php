...
<section id="entity_section" class="entity_section">
    ...
    <div class="related_news">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('front/assets/img/cat-mobi-sm2.jpg') }}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple"><a href="category.html" target="_self">Mobile</a></span>
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('front/assets/img/cat-mobi-sm4.jpg') }}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple"><a href="category.html" target="_self">Mobile</a></span>
    ...
    <div class="readers_comment">
        ...
        <div class="media">
            <div class="media-left">
                <a href="#">
                    <img alt="64x64" class="media-object" data-src="{{ asset('front/assets/img/reader_img1.jpg') }}"
                         src="{{ asset('front/assets/img/reader_img1.jpg') }}" data-holder-rendered="true">
                </a>
            </div>
            <div class="media-body">
