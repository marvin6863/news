                ...
                @foreach ($top_views as $post)
                    <div class="col-md-5" style="margin-bottom: 3%;">
                        <div class="feature_static_wrapper">
                            <div class="feature_article_img">
                                <img style="height: 267px;" width="450" class="img-responsive"
                                    src="{{ asset('post') }}/{{ $post->main_image }}" alt="{{ $post->title }}">
                            </div>
                            <!-- feature_article_img -->
                            ...
                            <div class="feature_article_inner">
                                ...
                                <div class="feature_article_content">
                                    {{ str_limit($post->short_description, 100) }} </div>
                                <!-- feature_article_content -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="top_article_img">
                                                    <a href="{{ url('/details') }}/{{ $post->slug }}"><img
                                                            class="img-responsive"
                                                            src="{{ asset('post') }}/{{ $post->list_image }}"
                                                            alt="{{ $post->title }}">
                                                    </a>
                                                </div>
                                                <!----top_article_img------>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="category_article_date"><a
                                                    ...
                                                    by: <a href="#">{{ $post->creator->name }}</a></div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <span class="media-date"><a
                                                        href="#">{{ date('j F -Y', strtotime($post->created_at)) }}</a>,
                                                    by: <a href="#">{{ $post->creator->name }}</a></span>
            ...
            <div class="widget m30">
                ...
                @foreach ($shareData['most_commented'] as $post)
                    <div class="media">
                        <div class="media-left">
                            <a href="{{ url('details') }}/{{ $post->slug }}"><img class="media-object"
                                    src="{{ asset('post') }}/{{ $post->thumb_image }}" alt="{{ $post->title }}"></a>
                        </div>
                        <div class="media-body">
                            <h3 class="media-heading">
                                <a href="{{ url('details') }}/{{ $post->slug }}">{{ $post->title }}</a>
